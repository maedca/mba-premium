...
<div class="container text-center">
    <div class="btn-group btn-group-toggle">
        <a class="btn btn-primary" href="{{ route('university.index') }}">All</a>
        <a class="btn btn-primary" href="{{ route('university.active') }}">Active Users</a>
        <a class="btn btn-primary active" href="{{ route('university.disable') }}">Archived Users</a>
    </div>
</div>
<br>
<div class="container">
    ...
    <table class="table table-light table-bordered table-hover table-sm" id="example">
        ...
        <tbody>
            @foreach ($users as $user)
                @if ($user->role === 'university' && $user->status === 0)                    
